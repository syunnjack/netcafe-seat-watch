...
const saveKey = 'netcafe-seat-watch.saved'
const postKey = 'netcafe-seat-watch.posts'
const alerts = [
  {
    "id": "netcafe-seat-watch-1",
    "title": "空席 alert seed 1",
    "area": "名古屋",
    "category": "空席",
    "score": 95,
    "summary": "空席、シャワー、鍵付き個室、料金、女性専用エリアを通知し、店舗送客とクーポンへつなげる。 空席の条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X"
    ],
  ...
  {
    "id": "netcafe-seat-watch-2",
    "title": "シャワー alert seed 2",
    "area": "東京",
    "category": "シャワー",
    "score": 92,
    "summary": "空席、シャワー、鍵付き個室、料金、女性専用エリアを通知し、店舗送客とクーポンへつなげる。 シャワーの条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X",
      "メール"
  ...
  {
    "id": "netcafe-seat-watch-3",
    "title": "鍵付き個室 alert seed 3",
    "area": "大阪",
    "category": "鍵付き個室",
    "score": 89,
    "summary": "空席、シャワー、鍵付き個室、料金、女性専用エリアを通知し、店舗送客とクーポンへつなげる。 鍵付き個室の条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X",
      "メール",
  ...
  {
    "id": "netcafe-seat-watch-4",
    "title": "女性向け alert seed 4",
    "area": "静岡",
    "category": "女性向け",
    "score": 86,
    "summary": "空席、シャワー、鍵付き個室、料金、女性専用エリアを通知し、店舗送客とクーポンへつなげる。 女性向けの条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X"
    ],
  ...
  return (
    <main className="app-shell">
      <section className="hero">
        <div>
          <p className="eyebrow">漫画喫茶・ネットカフェ空席/シャワー通知</p>
          <h1>Netcafe Seat Watch</h1>
          <p className="lead">空席、シャワー、鍵付き個室、料金、女性専用エリアを通知し、店舗送客とクーポンへつなげる。</p>
        </div>
        <aside className="hero-panel">
          <span>netcafeseat.jp / netcafe-seat-watch</span>
